...
# List of (owner, authority) address pairs for batch-minted Soulbound NFT items
# Each tuple: (owner_address, authority_address)
#   owner_address: receives the Soulbound NFT
#   authority_address: can revoke/destroy the item
...
async def main() -> None:
    ...
    # Build initialization data for each Soulbound NFT item
    # Iterates through (owner, authority) pairs with sequential indices starting from MINT_FROM_INDEX
    ...
    # Calculate and display addresses for all minted Soulbound NFT items
