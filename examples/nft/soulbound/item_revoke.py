...
async def main() -> None:
    ...
    # Wallet must be NFT authority to revoke successfully
    wallet, _, _, _ = WalletV4R2.from_mnemonic(client, MNEMONIC)

    # Construct revoke message body
    body = NFTRevokeBody()

    # Send revoke transaction to NFT item contract
    # destination: NFT item contract address
    # body: serialized revoke message
    ...
    # Display revoked NFT item address
