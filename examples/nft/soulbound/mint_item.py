...
# Authority address (can revoke/destroy Soulbound NFT)
...
async def main() -> None:
    ...
    # Build Soulbound NFT item initialization data (stored in item contract on deployment)
    # owner_address: initial owner of the Soulbound NFT item
    # authority_address: address authorized to revoke/destroy the item
    ...
    # item_ref: serialized initialization data (owner + authority + content)
    ...
    # Calculate Soulbound NFT item address deterministically
    ...
    # Display minted Soulbound NFT item address
