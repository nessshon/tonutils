...
TO_JETTON_MASTER_ADDRESS = "kQDLvsZol3juZyOAVG8tWsJntOxeEZWEaWCbbSjYakQpuYN5"  # noqa
...
async def main() -> None:
    ...
    to, value, body = await StonfiRouterV2(client).get_swap_ton_to_jetton_tx_params(
